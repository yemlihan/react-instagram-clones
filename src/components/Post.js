...
import {AiOutlineHeart,AiOutlineShareAlt,AiOutlineSave} from 'react-icons/ai'
...
function Post() {
    ...
    const modalDot = () => {
        if(modal === false){
            let showModal = document.querySelector('.dot-modal');
    ...
    return (
        <div className="post col-12 mt-3">
            <div className="post-card col-12 d-flex flex-column bg-white border border-1 mb-4">
                    ...
                    <div className="post-title-config col-1 d-flex text-end justify-content-end pointer">
                        ...
                        <div class="dot-modal" onClick={closeOverlay}>
                            <div className="post-settings d-flex flex-wrap">
                                ...
                                <div className="post-setting-item" onClick={closeOverlay}>
                                    İptal
                                </div>
                            </div>
                        </div>
                ...
                <div className="post-body col-12">
                    <img src="https://techcrunch.com/wp-content/uploads/2021/08/instagram-icon-ios-closeup.jpg" alt="" />
                </div>
                <div className="post-notifications col-12 d-flex flex-row align-items-center p-3">
                    <div className="post-notifications-icons col-3 d-flex">
                        <div>
                    ...
                    <div className="post-notifications-share col-9 d-flex justify-content-end">
                            <AiOutlineSave size="30"/>
                    </div>
                </div>
                <div className="post-likes col-12 ps-3 pb-2 d-flex flex-row align-items-center">
                    <div className="post-likes-icon d-flex align-items-center">
                        <img className="rounded-circle" width="24" height="24" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQgfN8ghjrrR-XoJNtShZN3vE2RNiGjGCXeA&usqp=CAU" alt="" />
                        <span className="ms-1"><b className="like-user">username</b> ve <b>diğer kişiler </b> beğendi</span>
                    </div>
                </div>
                <div className="post-comments col-12 ps-3 pb-2">
                    <span className="comment-post"><b className="like-user">username</b> user comments</span>
                </div>
                <div className="post-other-comments col-12 ps-3 pb-1">
                    <div className="post-total-comments">
                        250 yorumun tümünü gör
                    </div>
                    <div className="post-last-comments d-flex flex-column mt-1">
                        <span className="comment-post"><b className="like-user">username</b> comment last1</span>
                        <span className="comment-post"><b className="like-user">username</b> comment last2</span>
                    </div>
                </div>
                <div className="post-time col-12 ps-3 pb-2">
                    <span className="text-uppercase">4 saat önce</span>
                </div>
                <div className="post-add-comments col-12 d-flex p-3 align-items-center">
                    <div className="col-1">
                        <button><GrEmoji size="30"/></button>
                    </div>
                    <div className="col-10">
                        <input type="text" id="addComment" name="addComment" placeholder="Yorum ekle.." />
                    </div>
                    <div className="col-1">
                        <button className="post-share">Paylaş</button>
                    </div>
                </div>
            </div>
            <div className="post-card col-12 d-flex flex-column bg-white border border-1 mb-4">
                ...
                <div className="post-other-comments col-12 ps-3 pb-1">
                    ...
                    <div className="post-last-comments d-flex flex-column mt-1">
                        <span className="comment-post"><b>username</b> comment last1</span>
                        <span className="comment-post"><b>username</b> comment last2</span>
                    </div>
                </div>
                <div className="post-time col-12 ps-3 pb-2">
                    <span className="text-uppercase">4 saat önce</span>
