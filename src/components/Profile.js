...
import {BiTrim, BiUserPin} from 'react-icons/bi'
...
export default function Profile() {
    ...
    const postImg = users.users[0].posts;
    const arrImg = []
    for (let i = 0; i < postImg.length; i++) {
        const allUserImage = users.users[0].posts[i];
        arrImg.push(allUserImage)
    }  
                    ...
                    <div className="main d-flex flex-column w-100">
                        <div className="profile-info d-flex">
                                <div className="profile-icon">
                                    <img width="150" height="150" className="rounded-circle" src={user.userPP} alt="" />
                                </div>
                                <section>
                                    <div className="profile-all-infos d-flex flex-column w-100">
                                        ...
                                        <div className="profile-username w-100 d-flex">
                                            <span className="span-counter">{user.bio}</span>
                                        </div>
                                    </div>
                                </section>
                        </div>
                            ...
                            <div id="posts" className={collapse === 1 ? "active-content" : "content"}>
                                { arrImg.map((t,index) => (
                                    <div className="post-box" key={index}>
                                        <img width="293" height="293" src={t.img} alt="" />
                                    </div>
                                ))
                            }  
                            </div>
